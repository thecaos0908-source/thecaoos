  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        chaos: {
          wine: "hsl(var(--chaos-wine))",
          silver: "hsl(var(--chaos-silver))",
      ...
      fontFamily: {
        ...
        'display': ['Staatliches', 'Bebas Neue', 'sans-serif'],
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      animation: {
        ...
        "blink-color": "blink-color 4s ease-in-out infinite",
